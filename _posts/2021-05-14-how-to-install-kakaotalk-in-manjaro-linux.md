...
<div markdown="1" class="stepper text">
<h4 class="title" data-step="2">
카카오톡 설치
</h4>
1. playonlinux 실행 > 설치 > `install a non-listed program` 클릭
...
2. wine 6.0 Version으로 설정 (설치되어있지 않다면 설치 필요)
